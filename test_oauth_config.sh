...
echo "访问URL: https://42.194.181.242/oauth/douplus.php"
echo ""
...
echo "5️⃣  完整流程说明"
echo "------------------------------------------"
echo "步骤1: 用户访问 https://42.194.181.242/account/dashboard"
echo "步骤2: 点击'添加账号'按钮"
echo "步骤3: 系统调用 /api/account/oauth/url 生成授权链接"
echo "步骤4: 跳转到巨量引擎授权页面"
echo "步骤5: 授权成功后回调 https://42.194.181.242/oauth/douplus.php"
echo "步骤6: PHP处理回调，保存账号信息"
echo "步骤7: 自动跳转回 https://42.194.181.242/account/dashboard"
echo ""
